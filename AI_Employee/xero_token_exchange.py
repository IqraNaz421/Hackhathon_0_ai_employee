...
if __name__ == '__main__':
    # Extract code and verifier from command line arguments
    if len(sys.argv) < 3:
        print("Usage: python xero_token_exchange.py <authorization_code> <code_verifier>")
        sys.exit(1)

    auth_code = sys.argv[1]
    code_verifier = sys.argv[2]
    success = exchange_code_for_token(auth_code, code_verifier)
